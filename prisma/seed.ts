  ...
  for (const productSeed of productSeeds) {
    ...
    const product = await prisma.product.upsert({
      ...
      update: {
        ...
        seoTitle: productSeed.name,
        metaDescription: productSeed.description,
        ogImage: productSeed.images[0],
...
async function seedBanners(
  ...
  const banners = [
    ...
    },
    {
      ...
      link: "/categories/industrial-automation/plc-controllers/programmable-logic-controllers",
      position: 1,
    ...
    },
    {
      ...
      link: "/categories/industrial-automation/drives-motors/variable-frequency-drives",
      position: 1,
